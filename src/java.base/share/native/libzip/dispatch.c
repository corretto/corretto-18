...
ZIP_SwitchImplementation(const char *implementation) {
    ...
    if (!strncmp(BUNDLED, implementation, strlen(BUNDLED))) {
        ...
        deflateSetHeader_func = (deflateSetHeader_type)&Cr_z_deflateSetHeader;
        ...
        deflateBound_func = (deflateBound_type)&Cr_z_deflateBound;
